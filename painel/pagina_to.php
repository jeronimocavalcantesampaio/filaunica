...
?>
<h1>Página Termos</h1>
<p class='msg info'>Aqui você pode Editar o conteúdo da Página Termos. <b>Pode usar código HTML</b></p>
...
<?
$sql = mysql_query("SELECT * FROM termos ORDER BY id");
...
$id = $reg['id'];
echo "
<form action=pagina_to.php method=post>
...
<?
 ...
 $id = $_POST["id"];
$queryb = "UPDATE termos SET conteudo='$conteudo1' WHERE id='$id'";
