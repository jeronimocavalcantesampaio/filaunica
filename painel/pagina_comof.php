...
<p class='msg info'>Aqui você pode Editar o conteúdo da página como funciona. <b>Pode usar código HTML</b></p>
...
<?
$sql = mysql_query("SELECT * FROM como_funciona ORDER BY id");
...
$id = $reg['id'];
echo "
<form action=pagina_comof.php method=post>
...
<?
 ...
 $id = $_POST["id"];
$queryb = "UPDATE como_funciona SET conteudo='$conteudo1' WHERE id='$id'";
