...
<p class='msg info'>Aqui você pode Editar o conteúdo da página INICIAL. <b>Pode usar código HTML</b></p>
...
<?
$sql = mysql_query("SELECT * FROM home ORDER BY id");
...
$id = $reg['id'];
echo "
<form action=pagina_home.php method=post>
...
<?
 ...
 $id = $_POST["id"];
$queryb = "UPDATE home SET conteudo='$conteudo1' WHERE id='$id'";
