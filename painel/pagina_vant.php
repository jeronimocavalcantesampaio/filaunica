...
if(!$_POST) {
?>
<h1>Página Mais Vantagens</h1>
<p class='msg info'>Aqui você pode Editar o conteúdo da página Vantagens. <b>Pode usar código HTML</b></p>
...
<?
$sql = mysql_query("SELECT * FROM vantagem ORDER BY id");
...
$id = $reg['id'];
echo "
<form action=pagina_vant.php method=post>
...
<?
 ...
 $id = $_POST["id"];
$queryb = "UPDATE vantagem SET conteudo='$conteudo1' WHERE id='$id'";
