...
if(!$_POST) {
?>
<h1>Remover Link Lateral</h1>
<p class='msg info'>Aqui você pode remover os links da página lateral.</p>
...
<?
$sql = mysql_query("SELECT * FROM links ORDER BY id DESC");
...
<table width='100%'>
<tr>
  <td><form action=excluir_link2.php method=post>
<INPUT type=hidden name=id value=$id>
<INPUT name=FormsButton1 type=submit class='input-submit'   value='Remover'>
</form></td>
  <td>
<form action=$link method=post>
<INPUT type=submit class='input-submit' target='_blank' value='Acessar'>
</form>
...
<?
 ...
 $id = $_POST["id"];
$sqlex = "delete from links where id='$id'";
